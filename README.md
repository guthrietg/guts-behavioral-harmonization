...
│       └── wave3_cleaning.Rmd
└── docs/
    └── [team presentation describing the cleaning process]
```

Folder and presentation filenames may differ slightly from the example above.
...
The `docs/` directory contains a presentation originally prepared for the research team that provides a higher-level overview of the behavioral cleaning process and the rationale behind the audit-based workflow.
